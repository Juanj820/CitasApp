...
ESPECIALIDADES = [
    "General", "Cardiología", "Pediatría", "Dermatología", "Neurología", "Ginecología",
...
class DoctorView:
    def __init__(self, parent, controller, usuario_id):
        ...
        self.tabla.column("id", width=41)
        self.tabla.column("nombre", width=115)
        ...
        # ListaFrame para botones a la derecha, igualando el alto de la tabla
        ...
        tb.Button(btns_frame, text="Editar", bootstyle="warning", command=self.editar_doctor, width=16).pack(pady=6, padx=16)
