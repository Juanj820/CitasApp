...
class MainView:
    def __init__(self, root, usuario, on_logout):
        ...
        # Línea separadora tipo hr
        tk.Frame(self.sidebar, height=2, bg="#e0e0e0", relief="flat").pack(fill="x", padx=16, pady=(0,10))
        # --- OPCIÓN 1: Menú con frames y labels alineados a la izquierda, simulando botones ---
        ...
        self.footer_left = tb.Label(self.footer, text="", bootstyle="inverse-dark", anchor="w")
        self.footer_left.pack(side="left", fill="x", expand=True, padx=(20,0), pady=8)
        self.footer_center = tb.Label(self.footer, text="", bootstyle="inverse-dark", anchor="center")
        self.footer_center.pack(side="left", fill="x", expand=True, pady=8)
        self.footer_right = tb.Label(self.footer, text="", bootstyle="inverse-dark", anchor="e")
